...
# Prepare the model
base_model, preprocessing_function = {
    # VGG
    "VGG16":(
        keras.applications.vgg16.preprocess_input,
        VGG16(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    "VGG19":(
         keras.applications.vgg19.preprocess_input,
        VGG19(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    # ResNet
    "ResNet50":(
        keras.applications.resnet50.preprocess_input
        ResNet50(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    # Inception
    "InceptionV3":(
        keras.applications.inception_v3preprocess_input,
        InceptionV3(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    "Xception":(
        keras.applications.xception.preprocess_input,
        Xception(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    "InceptionResNetV2":(
        keras.applications.inceptionresnetv2.preprocess_input,
        InceptionResNetV2(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    # MobileNet
    "MobileNet":(
        keras.applications.mobilenet.preprocess_input,
        MbileNet(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    # DenseNet
    "DenseNet121":(
        keras.applications.densenet.preprocess_input,
        DenseNet121(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    "DenseNet169":(
        keras.applications.densenet.preprocess_input,
        DenseNet169(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    "DenseNet201":(
        keras.applications.densenet.preprocess_input,
        DenseNet201(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3))),
    # NASNet
    "NASNetLarge":(
        keras.applications.nasnet.preprocess_input,
        NASNetLarge(weights='imagenet', include_top=True, input_shape=(HEIGHT, WIDTH, 3))),
    "NASNetMobile":(
        keras.applications.nasnet.preprocess_input,
        NASNetMobile(weights='imagenet', include_top=False, input_shape=(HEIGHT, WIDTH, 3)))

}.get(args.model, ValueError("The model you requested is not supported in Keras"))
